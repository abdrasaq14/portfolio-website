...
const ProjectCard: React.FC<{ index: number } & TProject> = ({
  ...
  return (
    ...
    <div className="relative bg-tertiary w-full rounded-2xl p-5  min-h-[550px] flex flex-col justify-between overflow-hidden">
      {isOnGoing && (
...
const Works = () => {
  return (
    <>
      ...
      <div className="mt-20 grid gap-7 grid-cols-[repeat(auto-fill,minmax(300px,1fr))]">
